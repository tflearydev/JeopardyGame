...
//Ran into trouble while trying to allow 2 players to play at once, while they each have one button to race to see who gets to answer the question, PHASE 2 idea
...
//ran into a little trouble while trying to add the same functions to the rest of the boxes, as I thought that I was finished and only had to add to remaining boxes
//It does function, it then returns to the previous questions even if im not calling that number question inside of my array
